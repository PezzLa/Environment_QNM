...
\[Rho]profile[OptionsPattern[{prec\[Rho]->45}],r_,Mhalo_,param_,mode_]:=Block[{rh=2,\[Rho],a0,rc,rules,fact,xx},
...
background[OptionsPattern[{precision->55,eps->10^-4}],mode_,Mhalo_,param_,rout_]:=Block[{rh,r1,rules,m,F,\[Rho],r,
...
Nsolm=NDSolve[{m'[r]==4 \[Pi] r^2 \[Rho][r],m[rh]==M},m,{r,rh,rinf*10^10},Join[rules,{WorkingPrecision->OptionValue[precision]+extraprec}]][[1]];
